...
import (
	...
	usecase "final-project-backend/usecase"
)
...
func (_m *WalletUsecase) WithTrx(trxHandle *gorm.DB) usecase.WalletUsecase {
	ret := _m.Called(trxHandle)

	var r0 usecase.WalletUsecase
	if rf, ok := ret.Get(0).(func(*gorm.DB) usecase.WalletUsecase); ok {
		r0 = rf(trxHandle)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(usecase.WalletUsecase)
		}
	}
